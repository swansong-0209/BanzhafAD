...
Optimal_Multi_algo_HP_dict = {
    ...
    'TSPulse_FT': {'win_size': 96, 'prediction_mode': 'time', 'lr': 1e-4},
    'TSPulse_ZS': {'win_size': 96, 'prediction_mode': 'time'},
    ...
    'KANAD': {'win_size': 100, 'd_model': 8, 'lr': 0.001, 'epochs': 10, 'batch_size': 128},
    'BanzhafAD': {
            'window_size': 100,
            'patch_len': 10,
            'reduce_channels': 5,   # reduce_channels=5 only triggers adaptive channel reduction;
            'num_samples': 50,
            'n_prototypes': 'auto'
        }
}
